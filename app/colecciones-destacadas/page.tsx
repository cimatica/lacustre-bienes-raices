    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-20">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-mosque">Colecciones Destacadas</h1>
          <p className="text-nordic-muted mt-2">Explora todas nuestras propiedades seleccionadas cuidadosamente para el ojo exigente.</p>
        </div>
        ...
        {featured.length === 0 ? (
          <div className="py-20 text-center text-nordic-muted bg-white rounded-xl shadow-sm border border-nordic-dark/5">
            ...
            No hay colecciones destacadas disponibles por el momento.
          </div>
        ) : (
