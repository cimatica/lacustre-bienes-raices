    ...
    <div className="font-display bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center p-4 antialiased text-nordic-dark dark:text-gray-100 relative overflow-hidden">
      ...
      <main className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-nordic-dark dark:text-white mb-2">Welcome to Lacustre</h1>
        ...
        <div className="bg-white dark:bg-[#152e2a] rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 dark:border-mosque/20 backdrop-blur-sm">
          <div className="space-y-4">
            ...
            >
              ...
              {loadingGoogle ? (
                <span className="material-symbols-outlined animate-spin text-nordic-dark dark:text-white z-10 relative">progress_activity</span>
              ) : (
              ...
              <span className="relative z-10">{loadingGoogle ? 'Redirecting...' : 'Continue with Google'}</span>
            </button>
            <button
            ...
            >
              ...
              <span className="relative z-10">{loadingGithub ? 'Redirecting...' : 'Continue with GitHub'}</span>
            </button>
          </div>
