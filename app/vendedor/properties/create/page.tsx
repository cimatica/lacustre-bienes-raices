...
export default function VendedorCreatePropertyPage() {
  return (
        ...
        <div className="space-y-4">
          <nav aria-label="Breadcrumb" className="flex">
            <ol className="flex items-center space-x-2 text-sm text-gray-500 font-medium">
              ...
              <li aria-current="page" className="text-[#19322F]">Agregar Nueva</li>
            </ol>
          </nav>
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-[#19322F] tracking-tight mb-2">Agregar Nueva Propiedad</h1>
            <p className="text-base text-gray-500 max-w-2xl font-normal">
              Completa los detalles a continuación para crear una nueva publicación. Los campos marcados con * son obligatorios.
            </p>
          </div>
        </div>
      </header>

      <PropertyForm basePath="/vendedor/properties" />
    </main>
  );
}
