        ...
        {isOwner && userRole === 'vendedor' ? (
          ...
          <>
            ...
            <div className="relative group/share">
              ...
              <div className="absolute left-0 top-full mt-2 w-full bg-surface-darker border border-slate-700/50 rounded-xl shadow-xl opacity-0 invisible group-hover/share:opacity-100 group-hover/share:visible transition-all flex flex-col p-2 z-50 -translate-y-2 group-hover/share:translate-y-0">
