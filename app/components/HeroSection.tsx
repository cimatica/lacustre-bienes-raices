      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 px-4">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
          {dict.hero.findYour} <span className="relative inline-block">
            <span className="relative z-10 font-extrabold text-mosque">{dict.hero.sanctuary}</span>
        ...
        <form onSubmit={handleSearch} className="relative group max-w-2xl mx-auto">
          <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            <span className="material-icons text-slate-400 text-2xl group-focus-within:text-mosque transition-colors">search</span>
          </div>
          <input 
            className="block w-full pl-12 pr-4 py-4 rounded-xl border border-slate-700/50 bg-surface-dark text-white shadow-soft placeholder-slate-500 focus:ring-2 focus:ring-mosque focus:border-mosque focus:bg-surface-darker transition-all text-lg focus:outline-none" 
        ...
        <div className="flex items-center justify-start xl:justify-center gap-3 overflow-x-auto hide-scroll py-2 pb-4">
          <button 
            ...
            className={`whitespace-nowrap px-5 py-2 rounded-full text-sm font-medium transition-all ${
              propertyType === "Todos"
                ? "bg-mosque text-white shadow-lg shadow-mosque/20 hover:-translate-y-0.5"
                : "bg-surface-dark border border-slate-700/50 text-slate-400 hover:text-white hover:border-mosque/50 hover:bg-mosque/5"
            }`}
          >
          ...
          <button 
            ...
            className="whitespace-nowrap flex items-center gap-1 px-4 py-2 rounded-full text-slate-300 font-medium text-sm hover:bg-white/10 transition-colors"
          >
